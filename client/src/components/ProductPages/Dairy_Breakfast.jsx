  ...
  if (products.length === 0) {
    return (
      <div className="text-center py-10">
        <p className="text-gray-500">No dairy products available at the moment.</p>
      </div>
    );
  }
      ...
      {products.map((product) => (
        <div className="w-full" key={product._id}>
          <Card
            ...
            name={product.name}
            image={product.image}
            quantity={product.quantity || '500 g'} // Default quantity for dairy products
            price={product.price}
